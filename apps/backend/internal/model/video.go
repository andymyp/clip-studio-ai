...
type Video struct {
	...
	Platform    string    `gorm:"size:50;not null;uniqueIndex:idx_videos_platform_url" json:"platform"`
	URL         string    `gorm:"type:text;not null;uniqueIndex:idx_videos_platform_url" json:"url"`
	...
	AnalysisJobs []AnalysisJob `gorm:"constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"-"`
	Subtitles    []Subtitle    `gorm:"constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"-"`
}
